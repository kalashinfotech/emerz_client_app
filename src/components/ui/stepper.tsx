...
function StepperTrigger({ asChild = false, className, children, ...props }: StepperTriggerProps) {
  ...
  return (
    <button
      ...
      className={cn(
        'focus-visible:border-ring focus-visible:ring-ring/50 inline-flex items-center gap-3 rounded-full outline-none focus-visible:z-10 focus-visible:ring-[0px] disabled:pointer-events-none disabled:opacity-50',
        className,
      )}
